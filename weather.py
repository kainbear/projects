...
bot = telebot.TeleBot('7010537585:AAFpLsc6FL1RaM2JydV8LHBfFC4H_NJmVRM')
currency = CurrencyConverter()
amount = 0

@bot.message_handler(commands=['start'])
def start(message):
    bot.send_message(message.chat.id, 'Привет, введите сумму в долларах $$$')
...
def my_currency(message):
    try:
        ...
        bot.send_message(message.chat.id, f'Что-то не так Оо . Впишите значение заново:')
